        ...
        <div className="adminFormBoxContent">
          ...
          <Form className='adminFormBoxContentRight'>
            ...
            <Form.Group className="mb-3" controlId="formBasicPassword">
              ...
              <Form.Control type="text" placeholder="Date" name='time' value={data.time} onChange={handleChange("time")} />
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicPassword">
              <Form.Label>Venue</Form.Label>
              <Form.Control type="text" placeholder="Date" name='venue' value={data.venue} onChange={handleChange("venue")} />
            </Form.Group>
            <Form.Group className="mb-3" controlId="formBasicPassword">
